...
public class DateUtils {
    ...
    /**
     * @author lyao
     * @time   2017-12-26 下午2:53:58
     * @Title  secondDiff
     * @Description: 获取两个时间的秒数
     */
    public Long secondDiff(Date d1,Date d2){
    ...
    public static void main(String[] args) {
        Date begin = stringToDate("2018-03-16 00:59",yyyy_MM_dd_HH_mm);
        Date end = stringToDate("2018-03-19 00:59",yyyy_MM_dd_HH_mm);
        int num = getDateRangeNum(begin,end);
